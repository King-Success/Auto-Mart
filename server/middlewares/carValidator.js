...
class CarValidator {
  static validateCar(req, res, next) {
    ...
    req
      .checkBody("manufacturer", "manufacturer is required")
      .notEmpty()
      .trim();
    req
      .checkBody("model", "model is required")
      .notEmpty()
      .trim();
    ...
    if (errors) {
      console.log('from car validator', errors);
      return res
        .status(400)
  ...
  static validateStatus(req, res, next) {
    req
      .checkBody("status", "status is required")
      .notEmpty()
      .trim()
      .isString()
  ...
  static validateParams(req, res, next) {
    ...
    keys.forEach(key => {
      switch (key) {
        ...
        case "min_price":
          req
            .checkQuery("max_price", "There must also be a max_price")
            .notEmpty()
            .isCurrency({ allow_negatives: false, require_decimal: false })
        ...
        case "max_price":
          req
            .checkQuery("min_price", "There must also be a min_price")
            .notEmpty()
            .isCurrency({ allow_negatives: false, require_decimal: false })
