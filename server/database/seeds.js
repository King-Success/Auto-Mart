...
const carA = `INSERT INTO cars(owner, state, price, manufacturer, model, bodyType, mainImageUrl)
                    VALUES(1, 'new', 6500000, 'Tesla', 'model S', 'car', 'https://res.cloudinary.com/drjpxke9z/image/upload/v1549984207/pdp_nucvwu.jpg')`;

const carB = `INSERT INTO cars(owner, state, price, manufacturer, model, bodyType, mainImageUrl)
VALUES(1, 'used', 1500000, 'Toyota', 'Avalon 2006', 'car', 'https://res.cloudinary.com/drjpxke9z/image/upload/v1549984207/pdp_nucvwu.jpg')`;

const carC = `INSERT INTO cars(owner, state, price, manufacturer, model, bodyType, mainImageUrl)
VALUES(1, 'used', 1500000, 'Toyota', 'Avalon 2006', 'car', 'https://res.cloudinary.com/drjpxke9z/image/upload/v1549984207/pdp_nucvwu.jpg')`;

const carD = `INSERT INTO cars(owner, state, price, manufacturer, model, bodyType, mainImageUrl)
VALUES(1, 'used', 1500000, 'Yoyota', 'Avalon 2006', 'car', 'https://res.cloudinary.com/drjpxke9z/image/upload/v1549984207/pdp_nucvwu.jpg')`;
